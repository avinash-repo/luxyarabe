import {
  ...
  class OnlinePaymentOptionController {
    async addOnlinePaymentOption(req, res) {
      try {
  ...
  const OnlinePaymentOptionControllerObj = new OnlinePaymentOptionController();
  export default OnlinePaymentOptionControllerObj;
